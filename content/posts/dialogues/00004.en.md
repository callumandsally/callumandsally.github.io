...
{{% color "#6e5baa" %}}Japan's electricity mix: roughly two-thirds comes from fossil fuels (coal, LNG, and oil), shown in warm tones. Renewables and nuclear make up the rest.
...
Annual parcel deliveries in Japan over the past fifteen years, rising steadily to approximately 4.8 billion. That works out to about 40 parcels per person per year.{{% /color %}}
